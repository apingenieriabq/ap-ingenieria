    ...
    <tr>
      <td scope="col" >
        <div class="btn-group btn-group-sm btn-group-toggle" data-toggle="buttons">
          ...
          <button class="btn btn-xs btn-danger" onclick="mostrarFormularioEditarDocumentoAP({{DocumentoAP.documentoID}});"><i class="fas fa-trash"></i></button>
        </div>
      </td>
      ...
      <td scope="col">
        ...
        <a href="{{DocumentoAP.documentoURL}}" target="_blank" class="btn btn-xs btn-outline-royal-blue"><i class="far fa-link"></i></a>
        {% else %}
        <button class="btn btn-xs btn-outline-salmon" disabled ><i class="fas fa-unlink"></i></button>
        {% endif %}
      </td>
      <td scope="col">
        ...
        {% else %}
        <button class="btn btn-xs btn-outline-salmon" disabled ><i class="fas fa-camera"></i></button>
        {% endif %}
      </td>
      <td scope="col" title="{{DocumentoAP.documentoPUBLICO}}">
        {% if DocumentoAP.documentoPUBLICO == 'SI' %}
        <button onclick="mostrarConfirmacionCambiarSeguridadDocumentoAP({{DocumentoAP.documentoID}});" class="btn btn-xs btn-outline-java"><i class="fas fa-lock-open"></i></button>
        {% else %}
        <button onclick="mostrarConfirmacionCambiarSeguridadDocumentoAP({{DocumentoAP.documentoID}});"class="btn btn-xs btn-outline-salmon"><i class="fas fa-lock"></i></button>
        {% endif %}
      ...
      <td scope="col" title="{{DocumentoAP.documentoPUBLICADO}}">
        ...
        <button onclick="mostrarConfirmacionCambiarVisibilidadDocumentoAP({{DocumentoAP.documentoID}});" class="btn btn-xs btn-outline-java"><i class="fas fa-eye"></i></button>
        {% else %}
        <button onclick="mostrarConfirmacionCambiarVisibilidadDocumentoAP({{DocumentoAP.documentoID}});" class="btn btn-xs btn-outline-salmon"><i class="fas fa-eye-slash"></i></button>
        {% endif %}
        <small style="font-size: 0px;">{{DocumentoAP.documentoPUBLICADO}}</small>
      </td>
      <td scope="col">
        {% if DocumentoAP.documentoESTADO == 'ACTIVO' %}
        <button onclick="mostrarConfirmacionCambiarEstadoDocumentoAP({{DocumentoAP.documentoID}});" class="btn btn-xs btn-outline-java"><i class="fas fa-thumbs-up"></i></button>
        {% elseif DocumentoAP.documentoESTADO == 'INACTIVO' %}
        <button onclick="mostrarConfirmacionCambiarEstadoDocumentoAP({{DocumentoAP.documentoID}});" class="btn btn-xs btn-outline-salmon"><i class="fas fa-thumbs-down"></i></button>
        {% elseif DocumentoAP.documentoESTADO == 'PAPELERA' %}
        <button onclick="mostrarConfirmacionRecuperarDocumentoAP({{DocumentoAP.documentoID}});" class="btn btn-xs btn-outline-dark"><i class="fas fa-trash-alt"></i></button>
        {% endif %}
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#botonera_documentosAP.botonera").html('<button type="submit" onclick="mostrarFormularioNuevoDocumentoAP();" class="btn btn-sm btn-accent btn-primary"><i class="material-icons">add</i> Nuevo </button>');
} );
</script>