<form id="form-procesoAP" class="add-new-post" onsubmit="return false;" >
  <div class="page-header row no-gutters py-4">
    ...
    <div class="col-12 col-sm-4 d-flex align-items-center">
      ...
      {% if ProcesoAP %}
      <button type="button" onclick="confirmarBorrarProceso();" class="btn btn-sm btn-salmon ml-auto"><i class="material-icons">delete</i> Eliminar</button>
      {% endif %}
    </div>
  </div>
  <div class="row">
    <div class="col-lg-8 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div class="card-body">
            ...
            <input class="form-control form-control-lg mb-3" type="text" name="procesoTITULO" placeholder="Titulo del Proceso" value="{{ProcesoAP.procesoNOMBRE}}" required >

            <div id="editor-proceso-procesosAP" class="add-new-post__editor mb-1">{{ProcesoAP.procesoCONTENIDO|raw}}</div>
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item p-3">
              ...
              <span class="d-flex mb-2">
                ...
                <span class="text-warning">{% if ProcesoAP %}{{ProcesoAP.personaNOMBRES}} {{ProcesoAP.personaPAELLIDOS}}<br/><strong>{{ProcesoAP.cargoTITULO}}</strong>{% else %}-{% endif %}</span>
              </span>
              <span class="d-flex mb-2">
...
<script>
  ...
  jQuery(document).ready(function(){
    ...
    $("#form-procesoAP").submit(function(){
      ...
      Datos.append("procesoCONTENIDO", procesoCONTENIDO);
      Datos.append("procesoPUBLICADO", procesoPUBLICADO);
